...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BlockColoredLight.java
// Matthew J. Schultz (Korynkai) | Created : 20AUG19 | Last Modified : 27AUG19 by Matthew J. Schultz (Korynkai)
// Version : 0.0.1
// This is a source file for 'Cadmus Infrastructure'; it defines the Colored Light block.
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// The 'BlockColoredLight' Class
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

public class BlockColoredLight extends BlockLightBase implements ITileEntityProvider
{
    // Public Constructor
        ...
        public BlockColoredLight()
        {
            ...
            setRegistryName( "coloredlight" );
            setTranslationKey( BuildInfo.MOD_ID + ".coloredlight" );
            setHardness( .5F );
            setLightLevel( 1.0F );
    ...
    // Public Methods
        ...
        {
            return new TEColoredLight();
        }
}

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// End of 'BlockColoredLight.java'
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
